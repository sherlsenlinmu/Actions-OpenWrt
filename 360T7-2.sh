...
sed -i "s/DISTRIB_REVISION='%R'/DISTRIB_REVISION='R23.2.14'/g" package/base-files/files/etc/openwrt_release
sed -i "s/DISTRIB_DESCRIPTION='%D %V %C'/DISTRIB_DESCRIPTION='ImmortalWrt R23.2.14 '/g" package/base-files/files/etc/openwrt_release
...
svn co https://github.com/kiddin9/openwrt-packages/trunk/miniupnpd-iptables package/apps/miniupnpd-iptables
