...
sed -i 's/R22.2.2/R22.2.12/g' package/lean/default-settings/files/zzz-default-settings
...
svn co https://github.com/kenzok8/openwrt-packages/trunk/luci-app-passwall package/apps/passwall/luci-app-passwall
