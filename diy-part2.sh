...
sed -i 's/R22.2.2/R22.3.9/g' package/lean/default-settings/files/zzz-default-settings
...
svn co https://github.com/kenzok8/openwrt-packages/trunk/luci-app-passwall package/apps/luci-app-passwall
