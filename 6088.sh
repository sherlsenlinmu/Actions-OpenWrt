...
sed -i "s/DISTRIB_REVISION='%R'/DISTRIB_REVISION='R25.6.21'/g" package/base-files/files/etc/openwrt_release
sed -i "s/DISTRIB_DESCRIPTION='%D %V %C'/DISTRIB_DESCRIPTION='ImmortalWrt R25.6.21 '/g" package/base-files/files/etc/openwrt_release
